    ...
    <div id="templatemo_main">
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content">
                	<ul class="sidebar_list">
                    	<li class="first"><a href="http://localhost/prova/procedimentos">Submenu1</a></li>
                        <li class="last"><a href="http://localhost/prova/procedimentos">Submenu2</a></li>
                    </ul>
                </div>
            </div>
        </div>
		<div id="content" class="float_r">
			...
			<table>
				...
				<tr>
					<td><p><?php echo $e['Procedimento']['nome']; ?></p></td>
					<td><p class="product_price">$ <?php echo $e['Procedimento']['preco']; ?></p></td>
				</tr>
				<?php endforeach; ?>
			</table>
        </div>
