...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
    	<div id="site_title"><h1><a href="http://localhost/prova/home">Pet Store Brasilisco</a></h1></div>
        <div id="header_right">
        	<p>
    ...
    <div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                ...
                <li><a href="http://localhost/prova/checkOut" class="selected">Checkout</a></li>
