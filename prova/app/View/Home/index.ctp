...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
    	<div id="site_title"><h1><a href="http://localhost/prova/home">Área Geral</a></h1></div>
        <div id="header_right">
        	<p>
    ...
    <div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                <li><a href="http://localhost/prova/home" class="selected">Home</a></li>
        	...
        	<div class="sidebar_box"><span class="bottom"></span>
                ...
                <div class="content">
                	<ul class="sidebar_list">
						<li class="first"><a href="http://localhost/prova/menu">Sumenu</a></li>
                        <li class="last"><a href="http://localhost/prova/menu">Sumenu</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div id="templatemo_footer">
    	<p><a href="http://localhost/prova/home">Home</a> | <a href="http://localhost/prova/menu">Products</a> | <a href="http://localhost/prova/about">About</a> | <a href="http://localhost/prova/faqs">FAQs</a> | <a href="http://localhost/prova/checkOut">Checkout</a> | <a href="http://localhost/prova/contactus">Contact Us</a>
		</p>
